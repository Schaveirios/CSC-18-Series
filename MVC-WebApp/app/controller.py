...
from forms import Student, Course
    ...
    if request.method == 'POST':
        try:
            ...
            with sql.connect('dbTest.db') as conn:
                ...
                cur.execute("INSERT INTO studInfo(idno, firstn,midname,lastn,gnder,crse,yrlevel)VALUES(?,?,?,?,?,?,?)",(stud.idNo,stud.firstName,stud.midName,stud.lastName,stud.gender,stud.course, stud.yrLevel))
